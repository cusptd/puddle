...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('prompt', '0002_alter_category_options_prompt'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prompt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations', to='prompt.prompt')),
